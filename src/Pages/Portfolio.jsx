   ...
   const projects=[
    ...
    return(
        ...
        <div>
            ...
            <div className='flex justify-center items-start h-[60vh] w-full top-60 sticky'>
                <div>
                    <p className='text-xl font-semibold text-center'>Create, Connect, Celebrate</p>
                    <h1 className='font-Heading leading-tight text-center text-4xl font-bold text-gray-800'>We have thougtfully shaped innumerable websites over the years and successfully launched the same for many <span className='text-gray-500 block'>satisfied clients.</span></h1> 
                </div>
               
            </div>
            <div className='h-[200vh] flex flex-col'>
                <div className='grid grid-cols-2 absolute gap-40'>
                    <img src={Flowimg1} className='h-[200px] w-[300px] mr-[200px] -z-[9] rellax' data-rellax-speed="3"/>
                    <img src={Flowimg2} className='h-[200px] w-[300px] rellax -z-[9]' data-rellax-speed="-1"/>
                    <img src={Flowimg3} className='h-[200px] w-[300px] rellax' data-rellax-speed="4"/>
                    <img src={Flowimg4} className='h-[200px] w-[300px] rellax' data-rellax-speed="-3"/>
                    <img src={Flowimg5} className='h-[200px] w-[300px] rellax' data-rellax-speed="-2"/>
                    <img src={Flowimg6} className='h-[200px] w-[300px] rellax -z-[9]' data-rellax-speed="5"/>
                </div>
